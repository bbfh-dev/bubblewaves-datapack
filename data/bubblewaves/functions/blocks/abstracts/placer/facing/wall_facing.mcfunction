...
execute if score $Facing bubblewaves matches 1 at @s if block ~-1 ~ ~ #bubblewaves:air run scoreboard players set $Facing bubblewaves 0
execute if score $Facing bubblewaves matches 2 at @s if block ~ ~ ~-1 #bubblewaves:air run scoreboard players set $Facing bubblewaves 0
execute if score $Facing bubblewaves matches 3 at @s if block ~1 ~ ~ #bubblewaves:air run scoreboard players set $Facing bubblewaves 0
execute if score $Facing bubblewaves matches 4 at @s if block ~ ~ ~1 #bubblewaves:air run scoreboard players set $Facing bubblewaves 0