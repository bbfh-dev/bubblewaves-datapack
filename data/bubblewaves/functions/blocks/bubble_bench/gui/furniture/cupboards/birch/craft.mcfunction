...
execute if score $Material0 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. run clear @p[scores={bubblewaves=1}] birch_planks 1
...
execute if score $Material0 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. at @p[scores={bubblewaves=1}] run function give:bubblewaves/birch_cupboard