...
execute if score $Material1 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. run clear @s pink_wool 6
...
execute if score $Material1 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. run function give:bubblewaves/pink_office_chair