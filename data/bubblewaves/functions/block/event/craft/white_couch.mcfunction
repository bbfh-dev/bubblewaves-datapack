...
execute if score $Material1 bubblewaves matches 12.. if score $Material2 bubblewaves matches 2.. run clear @s white_wool 12
...
execute if score $Material1 bubblewaves matches 12.. if score $Material2 bubblewaves matches 2.. run function give:bubblewaves/white_couch