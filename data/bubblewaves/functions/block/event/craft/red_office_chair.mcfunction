execute store result score $Material1 bubblewaves run clear @s red_wool 0
execute store result score $Material2 bubblewaves run clear @s leather 0

execute if score $Material1 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. run clear @s red_wool 6
...
execute if score $Material1 bubblewaves matches 6.. if score $Material2 bubblewaves matches 1.. run function give:bubblewaves/red_office_chair