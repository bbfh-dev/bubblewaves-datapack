...
execute if score $Material1 bubblewaves matches 1.. if score $Material2 bubblewaves matches 1.. run clear @s oak_planks 1
...
execute if score $Material1 bubblewaves matches 1.. if score $Material2 bubblewaves matches 1.. run function give:bubblewaves/oak_shelf