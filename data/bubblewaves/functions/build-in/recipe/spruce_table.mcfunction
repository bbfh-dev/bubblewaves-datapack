...
execute if score %item0 bw.success matches 1 store result score %item1 bw.success run clear @s spruce_planks 3
...
execute if score %item0 bw.success matches 1 if score %item1 bw.success matches 3 run function bubblewaves:build-in/recipe/result/spruce_table