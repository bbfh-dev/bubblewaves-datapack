...
execute if score %item0 bw.success matches 1 if score %item1 bw.success matches 0..7 run give @s bucket 1
execute if score %item0 bw.success matches 1 if score %item1 bw.success matches 8 run function bubblewaves:build-in/recipe/result/washer