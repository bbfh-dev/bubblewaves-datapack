execute store result score %item0 bw.success run clear @s jungle_planks 8
...
execute if score %item0 bw.success matches 6 run give @s jungle_planks 6
execute if score %item0 bw.success matches 7 run give @s jungle_planks 7
execute if score %item0 bw.success matches 8 run function bubblewaves:build-in/recipe/result/jungle_nightstand